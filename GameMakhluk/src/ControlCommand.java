...
Logger.getLogger(ControlCommand.class.getName()).log(Level.SEVERE, null, ex);
    ...
    /** Set Pause menjadi b.
     * @param b untuk mengubah pause
     */
    public final void setPause(final boolean b) {
        pause = b;
    }
    /** Set Exit menjadi b.
     * @param b untuk mengubah exit
     */
    public final void setExit(final boolean b) {
        exit = b;
    }
    /** Set Screenshot menjadi b.
     * @param b untuk mengubah screenshot */
    public final void setScreenshot(final boolean b) {
        screenshot = b;
    }

    /**
     * Mengubah nilai step sesuai dengan b.
     * @param b variable untuk mengubah nilai dari step
     */
    public final void setStep(final boolean b) {
        step = b;
    }

    /**
     * Mengubah nilai dari spawn menjadi b.
     * @param b variable yang digunkanan untuk mengubah spawn
     */
    public final void setSpawn(final boolean b) {
        spawn = b;
    }
    /**
     * Mendapatkan nilai dari pause.
     * @return mengembalikan nilai pause
     */
    public final boolean getPause() {
        return pause;
    }
    /**
     * Mendapatkan nilai dari exit.
     * @return mengembalikan nilai untuk exit
     */
    public final boolean getExit() {
        return exit;
    }
    /**
     * Mendapatkan nilai screenshot.
     * @return mengembalikan nilai screenshot
     */
    public final boolean getScreenshot() {
        return screenshot;
    }
    /**
     * Mendapatkan nilai dari Step.
     * @return mengembalikan nilai step
     */
    public final boolean getStep() {
        return step;
    }
    /**
     * Mendapatkan nilai dari spawn.
     * @return mengembalikan nilai dari spawn
     */
